...
class UserDbStorageTest {
    ...
    void testGetCommonFriends() {
        ...
        userStorage.addFriend(user1.getUserId(), user2.getUserId());
        userStorage.addFriend(user2.getUserId(), user1.getUserId()); // подтверждение

        userStorage.addFriend(user1.getUserId(), user3.getUserId());
        userStorage.addFriend(user3.getUserId(), user1.getUserId()); // подтверждение

        userStorage.addFriend(user2.getUserId(), user3.getUserId());
        userStorage.addFriend(user3.getUserId(), user2.getUserId()); // подтверждение
    ...
    void testDeleteUser() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
                ru.yandex.practicum.filmorate.Validation.Exception.NotFoundException.class,
